...
if __name__ == '__main__':
    ...
    new_list = Category("Новое имя", "Новое описание", [smartphone1, grass2])
    check_class = [LawnGrass("Газонная трава", "Элитная трава для газона", 500.0, 20,
                             "Россия", "7 дней", "Зеленый"),
                   Smartphone("Iphone 15", "512GB, Gray space", 210000.0, 8,
                              98.2, "15", 512, "Gray space")]

    # check_class = [LawnGrass("Газонная трава", "Элитная трава для газона", 500.0, 20, "Россия", "7 дней", "Зеленый"),
    #                Smartphone("Iphone 15", "512GB, Gray space", 210000.0, 8, 98.2, "15", 512, "Gray space"),
    #                Category("Смартфоны", "Высокотехнологичные смартфоны", [smartphone1, smartphone2])]

    for product in check_class:
        if issubclass(product.__class__, Product):
            new_list.add_product(product)
        else:
            raise TypeError
        print(new_list.products)
